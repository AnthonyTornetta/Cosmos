...
pub struct OpenAdvancedWeaponsFabricatorEvent(pub StructureBlock);

impl IdentifiableEvent for OpenAdvancedWeaponsFabricatorEvent {
    fn unlocalized_name() -> &'static str {
        "cosmos:open_advanced_weapons_fabricator"
    }
}

impl NettyEvent for OpenAdvancedWeaponsFabricatorEvent {
...
pub struct CraftAdvancedWeaponsFabricatorRecipeEvent {
...
impl IdentifiableEvent for CraftAdvancedWeaponsFabricatorRecipeEvent {
    fn unlocalized_name() -> &'static str {
        "cosmos:craft_advanced_weapons_fabricator"
    }
}

impl NettyEvent for CraftAdvancedWeaponsFabricatorRecipeEvent {
    fn event_receiver() -> crate::netty::sync::events::netty_event::EventReceiver {
...
pub(super) fn register(app: &mut App) {
    app.add_netty_event::<OpenAdvancedWeaponsFabricatorEvent>()
        .add_netty_event::<CraftAdvancedWeaponsFabricatorRecipeEvent>();
}
