...
/// Reverses the operation of flatten, and gives the 2d x/y coordinates for a 2d array given a 1d array coordinate
pub fn expand_2d(index: usize, width: usize) -> (usize, usize) {
    let y = index / width;
    let x = index - y * width;
