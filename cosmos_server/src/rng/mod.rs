...
pub fn get_seed_for_sector_u64(server_seed: &ServerSeed, sector: &Sector) -> u64 {
    let (sx, sy, sz) = (sector.x(), sector.y(), sector.z());
...
///
/// If you just need a random number generator, prefer to use [`get_rng_for_sector`]
pub fn get_seed_for_sector_u32(server_seed: &ServerSeed, sector: &Sector) -> u32 {
...
pub fn get_rng_for_sector(server_seed: &ServerSeed, sector: &Sector) -> ChaCha8Rng {
