...
// #ifdef VERTEX_UVS
//         if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_EMISSIVE_TEXTURE_BIT) != 0u) {
//             emissive = vec4<f32>(emissive.rgb * textureSample(
...
//             pbr_input.material.clearcoat *= textureSample(
...
//             pbr_input.material.clearcoat_perceptual_roughness *= textureSample(
...
// #ifdef PBR_TRANSMISSION_TEXTURES_SUPPORTED
//         if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_SPECULAR_TRANSMISSION_TEXTURE_BIT) != 0u) {
//             specular_transmission *= textureSample(
...
// #ifdef PBR_TRANSMISSION_TEXTURES_SUPPORTED
//         if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_DIFFUSE_TRANSMISSION_TEXTURE_BIT) != 0u) {
//             diffuse_transmission *= textureSample(
...
// #ifdef VERTEX_UVS
//         if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_OCCLUSION_TEXTURE_BIT) != 0u) {
//             diffuse_occlusion *= textureSample(
...
//         let clearcoat_Nt = textureSample(
