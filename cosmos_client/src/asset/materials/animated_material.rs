use bevy::{
    pbr::{
        deferred::DEFAULT_PBR_DEFERRED_LIGHTING_PASS_ID, ExtendedMaterial, MaterialExtension, MaterialPipeline, MaterialPipelineKey,
...
pub type AnimatedArrayTextureMaterial = ExtendedMaterial<StandardMaterial, AnimatedArrayTextureMaterialExtension>;
...
pub struct AnimatedArrayTextureMaterialExtension {}

impl MaterialExtension for AnimatedArrayTextureMaterialExtension {
    ...
    fn specialize(
        ...
        let vertex_layout = layout.0.get_layout(&[
            ...
            ATTRIBUTE_PACKED_ANIMATION_DATA.at_shader_location(20),
        ])?;
...
// use bevy::bevy_reflect::{std_traits::ReflectDefault, Reflect};
// use bevy::bevy_render::{mesh::MeshVertexBufferLayoutRef, render_asset::RenderAssets, render_resource::*};
...
//         key.set(StandardMaterialKey::CULL_FRONT, material.cull_mode == Some(Face::Front));
//         key.set(StandardMaterialKey::CULL_BACK, material.cull_mode == Some(Face::Back));
//         key.set(StandardMaterialKey::NORMAL_MAP, material.normal_map_texture.is_some());
//         key.set(
//             StandardMaterialKey::RELIEF_MAPPING,
//             matches!(material.parallax_mapping_method, ParallaxMappingMethod::Relief { .. }),
//         );
//         key.set(StandardMaterialKey::DIFFUSE_TRANSMISSION, material.diffuse_transmission > 0.0);
//         key.set(StandardMaterialKey::SPECULAR_TRANSMISSION, material.specular_transmission > 0.0);
...
//         key.set(StandardMaterialKey::ANISOTROPY, material.anisotropy_strength > 0.0);

//         key.set(StandardMaterialKey::BASE_COLOR_UV, material.base_color_channel != UvChannel::Uv0);

//         key.set(StandardMaterialKey::EMISSIVE_UV, material.emissive_channel != UvChannel::Uv0);
//         key.set(
//             StandardMaterialKey::METALLIC_ROUGHNESS_UV,
//             material.metallic_roughness_channel != UvChannel::Uv0,
//         );
//         key.set(StandardMaterialKey::OCCLUSION_UV, material.occlusion_channel != UvChannel::Uv0);
//         #[cfg(feature = "pbr_transmission_textures")]
//         {
//             key.set(
...
//             );
//             key.set(StandardMaterialKey::THICKNESS_UV, material.thickness_channel != UvChannel::Uv0);
//             key.set(
...
//         key.set(StandardMaterialKey::NORMAL_MAP_UV, material.normal_map_channel != UvChannel::Uv0);

//         #[cfg(feature = "pbr_anisotropy_texture")]
//         {
//             key.set(StandardMaterialKey::ANISOTROPY_UV, material.anisotropy_channel != UvChannel::Uv0);
//         }

//         #[cfg(feature = "pbr_multi_layer_material_textures")]
//         {
//             key.set(StandardMaterialKey::CLEARCOAT_UV, material.clearcoat_channel != UvChannel::Uv0);
//             key.set(
...
//                 (StandardMaterialKey::NORMAL_MAP, "STANDARD_MATERIAL_NORMAL_MAP"),
...
//                 ),
//                 (StandardMaterialKey::CLEARCOAT, "STANDARD_MATERIAL_CLEARCOAT"),
//                 (StandardMaterialKey::CLEARCOAT_NORMAL_MAP, "STANDARD_MATERIAL_CLEARCOAT_NORMAL_MAP"),
//                 (StandardMaterialKey::ANISOTROPY, "STANDARD_MATERIAL_ANISOTROPY"),
//                 (StandardMaterialKey::BASE_COLOR_UV, "STANDARD_MATERIAL_BASE_COLOR_UV_B"),
//                 (StandardMaterialKey::EMISSIVE_UV, "STANDARD_MATERIAL_EMISSIVE_UV_B"),
//                 (
//                     StandardMaterialKey::METALLIC_ROUGHNESS_UV,
//                     "STANDARD_MATERIAL_METALLIC_ROUGHNESS_UV_B",
//                 ),
//                 (StandardMaterialKey::OCCLUSION_UV, "STANDARD_MATERIAL_OCCLUSION_UV_B"),
//                 (
//                     StandardMaterialKey::SPECULAR_TRANSMISSION_UV,
//                     "STANDARD_MATERIAL_SPECULAR_TRANSMISSION_UV_B",
//                 ),
//                 (StandardMaterialKey::THICKNESS_UV, "STANDARD_MATERIAL_THICKNESS_UV_B"),
//                 (
//                     StandardMaterialKey::DIFFUSE_TRANSMISSION_UV,
//                     "STANDARD_MATERIAL_DIFFUSE_TRANSMISSION_UV_B",
//                 ),
//                 (StandardMaterialKey::NORMAL_MAP_UV, "STANDARD_MATERIAL_NORMAL_MAP_UV_B"),
//                 (StandardMaterialKey::CLEARCOAT_UV, "STANDARD_MATERIAL_CLEARCOAT_UV_B"),
//                 (
//                     StandardMaterialKey::CLEARCOAT_ROUGHNESS_UV,
//                     "STANDARD_MATERIAL_CLEARCOAT_ROUGHNESS_UV_B",
//                 ),
//                 (StandardMaterialKey::CLEARCOAT_NORMAL_UV, "STANDARD_MATERIAL_CLEARCOAT_NORMAL_UV_B"),
//                 (StandardMaterialKey::ANISOTROPY_UV, "STANDARD_MATERIAL_ANISOTROPY_UV"),
//             ] {
...
//         descriptor.primitive.cull_mode = if key.bind_group_data.contains(StandardMaterialKey::CULL_FRONT) {
//             Some(Face::Front)
