...
// };
//
// use crate::{state::game_state::GameState, structure::station::client_station_builder::ClientStationBuilder};
//
...
//         .add_systems(Update, print_value.run_if(in_state(GameState::Playing)));
// }
//
// #[derive(Component)]
// struct Done;
