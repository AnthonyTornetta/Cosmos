...
impl MaterialExtension for ArrayTextureMaterialExtension {
    ...
    fn specialize(
        ...
        let vertex_layout = layout.0.get_layout(&[ATTRIBUTE_TEXTURE_INDEX.at_shader_location(20)])?;
...
//     ///
//     /// For specular transmission usecases with refraction (e.g. glass) use the [`ArrayTextureMaterial::specular_transmission`] and
//     /// [`ArrayTextureMaterial::ior`] properties instead.
//     ///
...
//     /// ## Notes
//     ///
//     /// - The material's [`ArrayTextureMaterial::base_color`] also modulates the transmitted light;
...
//     /// The material's [`ArrayTextureMaterial::base_color`] also modulates the transmitted light.
//     ///
//     /// **Note:** Typically used in conjunction with [`ArrayTextureMaterial::thickness`], [`ArrayTextureMaterial::ior`] and [`ArrayTextureMaterial::perceptual_roughness`].
//     ///
//     /// ## Performance
//     ///
...
//     ///
//     /// **Note:** Typically used in conjunction with [`ArrayTextureMaterial::specular_transmission`] and [`ArrayTextureMaterial::ior`], or with
//     /// [`ArrayTextureMaterial::diffuse_transmission`].
//     #[doc(alias = "volume")]
...
//     /// | Moissanite      | 2.65                 |
//     ///
//     /// **Note:** Typically used in conjunction with [`ArrayTextureMaterial::specular_transmission`] and [`ArrayTextureMaterial::thickness`].
...
//     /// - [`ArrayTextureMaterial::attenuation_color`];
//     /// - [`ArrayTextureMaterial::thickness`];
//     /// - [`ArrayTextureMaterial::diffuse_transmission`] or [`ArrayTextureMaterial::specular_transmission`].
...
//     ///
//     /// **Note:** To have any effect, must be used in conjunction with:
//     /// - [`ArrayTextureMaterial::attenuation_distance`];
//     /// - [`ArrayTextureMaterial::thickness`];
//     /// - [`ArrayTextureMaterial::diffuse_transmission`] or [`ArrayTextureMaterial::specular_transmission`].
...
// impl From<Color> for ArrayTextureMaterial {
...
// impl From<Handle<Image>> for ArrayTextureMaterial {
...
// impl ArrayTextureMaterialFlags {
...
//             flags |= ArrayTextureMaterialFlags::EMISSIVE_TEXTURE;
//         }
//         if self.metallic_roughness_texture.is_some() {
//             flags |= ArrayTextureMaterialFlags::METALLIC_ROUGHNESS_TEXTURE;
//         }
//         if self.occlusion_texture.is_some() {
//             flags |= ArrayTextureMaterialFlags::OCCLUSION_TEXTURE;
//         }
//         if self.double_sided {
//             flags |= ArrayTextureMaterialFlags::DOUBLE_SIDED;
//         }
//         if self.unlit {
//             flags |= ArrayTextureMaterialFlags::UNLIT;
//         }
//         if self.fog_enabled {
//             flags |= ArrayTextureMaterialFlags::FOG_ENABLED;
//         }
...
//                         flags |= ArrayTextureMaterialFlags::TWO_COMPONENT_NORMAL_MAP;
//                     }
//                     _ => {}
//                 }
//             }
//             if self.flip_normal_map_y {
//                 flags |= ArrayTextureMaterialFlags::FLIP_NORMAL_MAP_Y;
//             }
//         }
//         // NOTE: 0.5 is from the glTF default - do we want this?
//         let mut alpha_cutoff = 0.5;
//         match self.alpha_mode {
//             AlphaMode::Opaque => flags |= ArrayTextureMaterialFlags::ALPHA_MODE_OPAQUE,
//             AlphaMode::Mask(c) => {
//                 alpha_cutoff = c;
//                 flags |= ArrayTextureMaterialFlags::ALPHA_MODE_MASK;
//             }
//             AlphaMode::Blend => flags |= ArrayTextureMaterialFlags::ALPHA_MODE_BLEND,
