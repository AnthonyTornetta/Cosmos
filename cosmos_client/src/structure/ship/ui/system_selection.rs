...
//     ui::{components::show_cursor::no_open_menus, item_renderer::RenderItem},
// };
...
// #[derive(Component)]
// pub struct HotbarHolder;

// fn listen_for_change_events(
//     mut query_hb: Query<&mut Hotbar>,
//     q_inventory_changed: Query<&HotbarContents, (Changed<HotbarContents>, With<HotbarHolder>)>,
//     q_inventory: Query<&HotbarContents, With<HotbarHolder>>,
...
//             if let Ok(inv) = q_inventory.get_single() {
...
//         if let Ok(inv) = q_inventory_changed.get_single() {
